/* input & output fields */
const Age_Input: HTMLInputElement = document.querySelector('#Age_Input')!;
const Gender_Input: HTMLSelectElement = document.querySelector('#Gender_Input')!;
const Weight_Input: HTMLInputElement = document.querySelector('#Weight_Input')!;
const Height_Input: HTMLInputElement = document.querySelector('#Height_Input')!;

const RestHours_Input: HTMLInputElement = document.querySelector('#RestHours_Input')!;
const LightHours_Input: HTMLInputElement = document.querySelector('#LightHours_Input')!;
const VeryLightHours_Input: HTMLInputElement = document.querySelector('#VeryLightHours_Input')!;
const NormalHours_Input: HTMLInputElement = document.querySelector('#NormalHours_Input')!;
const HeavyHours_Input: HTMLInputElement = document.querySelector('#HeavyHours_Input')!;
const VeryHeavyHours_Input: HTMLInputElement = document.querySelector('#VeryHeavyHours_Input')!;
const TotalHours_Output: HTMLInputElement = document.querySelector('#TotalHours_Output')!;
const Base_Output: HTMLInputElement = document.querySelector('#BaseOutput')!;
const Total_Output: HTMLInputElement = document.querySelector('#TotalOutput')!;
const CalculateCalories_Button: HTMLButtonElement = document.querySelector('.CalculateCaloriesBtn')!;


const Makro_Output: HTMLElement = document.querySelector('#Makro_Output')!;
const CalculateMakrosBtn: HTMLButtonElement = document.querySelector('.CalculateMakrosBtn')!;
const Total_Input: HTMLInputElement = document.querySelector('#Total_Input')!;
const NutritionType_Input: HTMLInputElement = document.querySelector('#NutritionType_Input')!;
...
let VeryLightHours: number;
let LightHours: number;
let NormalHours: number;
let HeavyHours: number;
let VeryHeavyHours: number;
...
function calculateMacronutrients(totalCalories:number, nutritionType:String) {
